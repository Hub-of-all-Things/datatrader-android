...
class OfferDetailsActivity : AppCompatActivity() {
    ...
    private fun initialize() {
        ...
        expiredDateOfferDetails.text =
            HATDateHelper().tryParseDateOutput(offerObject?.offerExpires, "'Expires 'd MMM yyyy")
        ...
        if (offerObject?.dataConditions?.bundle != null) {
            offerDetailsCriteriaTitle.text =
                DataOfferCriteriaManager().getBundleTxt(offerObject?.dataConditions?.bundle!!)
        } else {
            ...
            when (state) {
                DataOfferStatusManager.Accepted -> {
                    ...
                    DataOfferStatusManager.setupProgressBarOld(
                        offerObject!!,
                        offerDetailsProgressBar,
                        offerDetailsProgressTextView,
                        this
                    )
